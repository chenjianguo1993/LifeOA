package com.oa.common.tool.page;
...
/**
 * @author linjiekai 2011-7-12 上午11:18:29 PageSettings.java
 */
public class PageSettings implements Serializable
{
	...
	protected String order = null;// 设置排序字段，多个字段用，隔开
									// 格式（name:desc,createDate:asc）
